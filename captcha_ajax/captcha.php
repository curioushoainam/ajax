...
class Captcha{
	...
	var $font_path	= './fonts';	// đường dẫn đến thư mục file
	var $fonts		= array();
	var $font_size	= 15;
	...
	function get_and_show_image($override = array()){
		...
		// Lấy danh sách fonts trong folder được định nghĩa trong font_path
